      ...
      >
        <CardHeader className="pb-3">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            ...
            <div className="flex flex-col items-end gap-3 mt-1 sm:mt-0">
              ...
              {experience.link && (
                <Link 
                  ...
                  target="_blank" 
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-500/10 hover:bg-blue-500/20 dark:bg-blue-400/10 dark:hover:bg-blue-400/20 backdrop-blur-md border border-blue-500/20 dark:border-blue-400/20 text-blue-600 dark:text-blue-400 transition-all duration-300 shadow-[0_0_10px_rgba(59,130,246,0.1)] hover:shadow-[0_0_15px_rgba(59,130,246,0.2)]"
                  title="View Certificate"
                >
                  <Award className="w-4 h-4 drop-shadow-sm" />
                  <span className="text-[10px] sm:text-xs font-semibold tracking-wide">View Certificate</span>
                </Link>
              )}
            </div>
          </div>
